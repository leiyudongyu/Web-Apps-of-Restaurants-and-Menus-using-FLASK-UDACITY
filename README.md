# Restfull web application of restaurants and corresponding menus using Python Flask framwork and sqlite database，using third party Auth provider Google+, Facebook to build login system, checking user authentication.
...
- Skills: Google+ API, Facebook SDK, SQLalchemy API, Sqlite Database, Python, Javascript, JQuery, Ajax, HTML, CSS, Json
