...
Features: <br/>
&nbsp1.Using Flask ( a light Python web framework).<br/>
&nbsp2.Using OAuth 2.0 to Access Google APIs and Facebook API.<br/>
&nbsp &nbsp &nbsp a.You can login using your google or facebook account.<br/>
&nbsp &nbsp &nbsp b.Only the owner can manage his own restaurants.<br/>
&nbsp3.Using RESRfull APIs, like Post and Get.<br/>
&nbsp4.Providing JSON APIs, which you can exploit to get the information you want.<br/>
